        ...
        <div className="rounded-3xl border border-slate-200/80 bg-white p-8 shadow-xl sm:p-10">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-xs text-slate-500">
              Join Fit Forever India to track and manage your fitness purchases.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="fullname" className="text-xs font-semibold uppercase text-slate-700">
                Full Name
              </Label>
              ...
              {validationErrors.name && (
                <p className="text-[11px] font-medium text-destructive mt-1 ml-1">{validationErrors.name}</p>
              )}
            </div>
